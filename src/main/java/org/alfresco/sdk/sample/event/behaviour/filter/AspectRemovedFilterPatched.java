...
public class AspectRemovedFilterPatched extends AbstractEventFilter {
    ...
    public boolean test(RepoEvent<DataAttributes<Resource>> event) {
        ...
        if (isNodeEvent(event)) {
            ...
            final boolean aspectExistedBefore =
                    (nodeResourceBefore != null && nodeResourceBefore.getAspectNames() != null
                            && nodeResourceBefore.getAspectNames().contains(acceptedAspect));
